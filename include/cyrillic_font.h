...
// Кириллический шрифт 5x8 пикселей
// Символы: А, Б, В, Г, Д, Е, Ж, З, И, Й, К, Л, М, Н, О, П, Р, С, Т, У, Ф, Х, Ц, Ч, Ш, Щ, Ъ, Ы, Ь, Э, Ю, Я
const uint8_t cyrillic_font[] = {
    // Базовый латинский алфавит (ASCII 32-127)
    ...
    // Кириллические символы (начиная с индекса 128)
    0x7E, 0x11, 0x11, 0x11, 0x7E, // А (128)
    0x7F, 0x49, 0x49, 0x49, 0x33, // Б
    0x7F, 0x49, 0x49, 0x49, 0x36, // В
    0x7F, 0x01, 0x01, 0x01, 0x01, // Г
    0x3E, 0x41, 0x41, 0x41, 0x22, // Д
    ...
    0x7C, 0x40, 0x40, 0x40, 0x3C, // ц
    0x0C, 0x10, 0x10, 0x10, 0x7C, // ч
    0x7C, 0x40, 0x7C, 0x40, 0x7C, // ш
    0x7C, 0x40, 0x7C, 0x40, 0xFC, // щ
    0x04, 0x04, 0x7C, 0x44, 0x44, // ъ
    0x7C, 0x40, 0x40, 0x40, 0x7C, // ы
    0x7C, 0x44, 0x44, 0x44, 0x44, // ь
    0x44, 0x44, 0x54, 0x54, 0x38, // э
    0x7C, 0x10, 0x38, 0x44, 0x38, // ю
    0x48, 0x54, 0x54, 0x54, 0x24  // я (191)
};

// Определение шрифта для использования в TFTDisplay
const struct AppFont CYRILLIC_FONT = {
    cyrillic_font,   // Данные шрифта
    5,               // Ширина символа
    8,               // Высота символа
    32,              // Первый символ (пробел)
    192              // Последний символ (русская я)
}; 